...
window.DP_DB = {
  ...
  shop: {
    name: 'Dp line',
    city: 'Магнитогорск',
    phone: '+7 (3519) 59-09-21',
    phoneHref: 'tel:+73519590921',
    phone2: '+7 909 099-42-49',
    phone2Href: 'tel:+79090994249',
    telegram: 'https://t.me/dpline_mgn',   /* TODO: реальная ссылка на Telegram */
    branches: '2 филиала',
    supplierCount: '30+',
  },

  pickup: {
    title: 'Выдача заказов Dp line',
    address: 'Магнитогорск, ул. Лесопарковая, 95а',
    note: 'Правобережный район, 455025 · выдача интернет-заказов — только здесь',
    hours: [                                /* TODO: подтвердить часы работы */
