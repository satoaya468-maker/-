...
const cases = [
  ...
  /* Заявки из очереди сайта: при досылке к источнику дописывается
     «· отложенная». Оценка при этом обязана остаться без телефона —
     релей узнаёт её по началу строки, а не по точному совпадению. */
  ['отложенный чат',  { source: 'Чат-виджет · отложенная', phone: '+79088196369', car: 'Niva', time: '25.08.2026, 09:11' }],
  ['отложенная оценка', { source: 'Оценка сайта: 2 звёзд · отложенная', score: 2, comment: 'лежала в очереди' }]
];
